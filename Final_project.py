...
mydb = mysql.connector.connect(
    ...
    database="Guvi_LLM"  # Replace with your MySQL database name
)
...
model_name = "/Users/naveenmoorthy/Desktop/Code/Naveen/fine_tuned_model"  # Replace with your actual model name
